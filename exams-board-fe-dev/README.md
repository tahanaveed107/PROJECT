...
```
cd existing_repo
git remote add origin https://gitlab.com/wajishah786/exams-board-fe.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/wajishah786/exams-board-fe/-/settings/integrations)
